...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Projet ayant pour but de déterminer si les statisques d'un joueur de NCAA suffisent à prédire sa performance en NBA", 
    description:
      "Création d'un MLP (Multi-Layer Perceptron) from Scratch en C++. Exploitation du modèle en Python et interface utilisateur en Django. ",
